...
class workerEdit extends React.Component {
    ...
    handleSubmit(e){
      ...
      if (user) {
          dispatch(userActions.updateUser(id, user));
      }
    }
    ...
    loadWorker() {
        ...
        dispatch(userActions.getWorker(id));
    }
...
const connectedworkerEdit = connect(mapStateToProps)(workerEdit);
export { connectedworkerEdit as workerEdit }; 